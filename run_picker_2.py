...
def gather(universe):
    ...
    from src.community import load_community_signals, load_ai_moat
    from src.dataroma import get_superinvestor_data as fetch_dataroma_fallback
    from src.reddit import get_reddit_mentions as fetch_reddit_fallback
    from src.twitter import get_x_sentiment_score as fetch_x_fallback
    ...
    from src.data_providers import fetch_fundamentals
    ...
    for tk in universe:
        try:
            ...
            from src.data_providers import get_pe_history_features, get_insider_summary, get_analyst_summary
